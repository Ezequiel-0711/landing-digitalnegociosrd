...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Bot de WhatsApp para automatizar pedidos de tu restaurante o negocio de comida en República Dominicana. Desde RD$4,000/mes.',
    type: 'website',
    images: [
      {
  ...
  other: {
    'facebook-domain-verification': 'yf7tgbv75qce8kjsd6bf8jdgj15634',
  },
}
